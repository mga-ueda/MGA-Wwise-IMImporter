...
internal sealed class WaveformPreviewData
{
    ...
    /// <summary>
    /// 複数波形モード時のソース区間。単体／XML 時は空。
    /// </summary>
    public IReadOnlyList<WaveformSourceSpan> SourceSpans { get; }

    /// <summary>XML なし・複数 WAV の仮想連結プレビューか。</summary>
    public bool IsMultiWaveOnly => SourceSpans.Count > 1;
}
